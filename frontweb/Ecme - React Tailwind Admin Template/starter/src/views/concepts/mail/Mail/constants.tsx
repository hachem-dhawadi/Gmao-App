...
export const typeIconMap: Record<string, JSX.Element> = {
    ...
    wo_due_soon:        <TbClockExclamation />,
    comment_mention:    <TbAt />,
    low_stock:          <TbAlertTriangle />,
    pm_assigned:        <TbCalendarRepeat />,
    pm_wo_generated:    <TbCalendarRepeat />,
    pm_overdue:         <TbClockExclamation />,
    po_ordered:         <TbReceipt />,
    new_member:         <TbUserPlus />,
    new_request:        <TbClipboardList />,
    request_converted:  <TbRefresh />,
    request_rejected:   <TbAlertTriangle />,
}
...
export const typeLabelMap: Record<string, string> = {
    ...
    wo_due_soon:        'Work Order',
    comment_mention:    'Work Order',
    low_stock:          'Inventory',
    pm_assigned:        'PM Plan',
    pm_wo_generated:    'PM Plan',
    pm_overdue:         'PM Plan',
    po_ordered:         'System',
    new_member:         'System',
    new_request:        'Work Order',
    request_converted:  'Work Order',
    request_rejected:   'Work Order',
}
...
export const typeCategoryMap: Record<string, string> = {
    ...
    wo_due_soon:        'work_order',
    comment_mention:    'work_order',
    low_stock:          'inventory',
    pm_assigned:        'pm_plan',
    pm_wo_generated:    'pm_plan',
    pm_overdue:         'pm_plan',
    po_ordered:         'system',
    new_member:         'system',
    new_request:        'work_order',
    request_converted:  'work_order',
    request_rejected:   'work_order',
}
