...
import { TbBarcode, TbSearch, TbAlertTriangle, TbX, TbCamera, TbKeyboard } from 'react-icons/tb'
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">
                            {mode === 'camera' ? 'Point camera at the item barcode' : 'Scan with USB reader or type manually'}
                        </p>
                    </div>
                </div>
                <button
            ...
            {mode === 'camera' && (
                <div className="mb-4">
                    ...
                    <p className="text-xs text-center text-gray-400 mt-2">
                        Auto-detects barcode — no button needed
                    </p>
                </div>
            )}
