...
import { apiUpdateItem, apiGetItemById } from '@/services/InventoryService'
import { useNavigate, useParams } from 'react-router-dom'
import { mutate as globalMutate } from 'swr'
import useSWR from 'swr'
import { TbArrowNarrowLeft } from 'react-icons/tb'
import type { ItemFormSchema } from '../ItemForm/ItemForm'
import type { ItemResponse } from '@/services/InventoryService'
...
const ItemEdit = () => {
    ...
    const handleFormSubmit = async (values: ItemFormSchema) => {
        ...
        try {
            ...
            await apiUpdateItem(id, formData)
    ...
    return (
        <>
            <ItemForm item={item} onFormSubmit={handleFormSubmit}>
                <Container>
            ...
            >
                <p>Discard your changes? They will be lost.</p>
            </ConfirmDialog>
        </>
    )
}
