...
export const apiGetWoReport    = (p?: ReportParams) => api.get<{ success: boolean; data: WoReportData }>('/reports/work-orders', { params: p })
export const apiGetAssetReport = (p?: ReportParams) => api.get<{ success: boolean; data: AssetReportData }>('/reports/assets', { params: p })
export const apiGetPmReport    = (p?: ReportParams) => api.get<{ success: boolean; data: PmReportData }>('/reports/pm', { params: p })
export const apiGetInvReport   = (p?: ReportParams) => api.get<{ success: boolean; data: InventoryReportData }>('/reports/inventory', { params: p })
